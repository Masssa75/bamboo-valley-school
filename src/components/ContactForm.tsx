  ...
  if (status === "success") {
    return (
      <div className="bg-[#FAF9F6] p-8 rounded-lg text-center">
        ...
        <h3 className="font-serif text-2xl font-normal mb-2 text-[#2d2d2d]">Message Sent!</h3>
        <p className="text-[#666] mb-6">We&apos;ll get back to you as soon as possible.</p>
        <button
  ...
  return (
    <div className="bg-[#FAF9F6] p-8 rounded-lg">
      ...
      <div className="mt-6 pt-6 border-t border-gray-200 text-center">
        <p className="text-sm text-[#666] mb-2">Prefer to chat?</p>
        <a
