            ...
            <div>
              ...
              <div className="bg-[#FAF9F6] p-8 rounded-lg">
                <p className="text-[#444] mb-6">
                  We welcome families to visit during school hours to see our children in action.
                  Tours typically last 30-45 minutes and include:
                </p>

                <ul className="space-y-3 text-[#444] mb-8">
                  <li className="flex items-start gap-3">
                    <span className="text-[#8fb07a] mt-1">✓</span>
                    <span>A walk through our 5,600 sqm campus</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#8fb07a] mt-1">✓</span>
                    <span>Observation of children during activities</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#8fb07a] mt-1">✓</span>
                    <span>Meeting with teachers</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#8fb07a] mt-1">✓</span>
                    <span>Q&A about our approach and programs</span>
                  </li>
                </ul>

                <a
                  href="https://wa.me/66989124218?text=Hi!%20I'd%20like%20to%20schedule%20a%20visit%20to%20Bamboo%20Valley."
                  target="_blank"
                  rel="noopener noreferrer"
